...
// Keep the list in scope (unused for now, defined for future NavigationGrid use)
        ...
        <div className="space-y-6 short:space-y-3">
            ...
            <div className="flex items-center justify-between gap-3 short:gap-2">
                <div className="flex items-center gap-3">
                    <ClipboardList className="h-8 w-8 text-green-600 short:h-6 short:w-6" />
                    <h1 className="text-3xl font-bold text-cifp-neutral-900 short:text-xl">Materiales</h1>
                </div>

                <Button
                    onClick={() => navigate('/inventory/full')}
            ...
            <Card className="overflow-hidden flex flex-col max-h-[calc(100vh-16rem)] short:max-h-[calc(100vh-8rem)]">
                <div className="px-6 py-4 bg-cifp-neutral-50 border-b border-cifp-neutral-200 flex-shrink-0 short:px-4 short:py-2">
                    <h2 className="text-lg font-semibold text-cifp-neutral-900 short:text-base">Resumen de Materiales</h2>
                    <p className="text-sm text-cifp-neutral-600 mt-1 short:text-xs">
                        Vista rápida de materiales (prioridad: stock crítico)
                    </p>
                </div>
                ...
                <div className="px-6 py-4 bg-cifp-neutral-50 border-t border-cifp-neutral-200 flex-shrink-0 short:px-4 short:py-2">
                    <div className="flex items-start gap-2 text-cifp-neutral-600 text-sm short:text-xs">
                        ...
                        <p>
                            Mostrando <span className="font-semibold">{displayMaterials.length}</span> de{' '}
                            <span className="font-semibold">{allMaterials.length}</span> materiales.
